...
export default function Music() {
  ...
  return (
    <div className="block w-screen h-screen">
      ...
      <div
        className="absolute top-0 left-0 w-screen h-screen bg-cover bg-top  z-0 blur-[4px] brightness-[.5] saturate-50 "
        style={{
          backgroundImage: `url(${curMusic._coverUrl || "https://mcontent.migu.cn/newlv2/new/album/20210513/8592/s_yaLskeLyyeLOsIJf.jpg"})`,
        }}
      ></div>
    </div>
  );
