...
- EdgeOne Functions entry points live in the repository root `edge-functions/` directory and cover `/health`, `/v1/*`, and the legacy `/api/*` proxy paths, avoiding Node cloud function proxy timeouts.
