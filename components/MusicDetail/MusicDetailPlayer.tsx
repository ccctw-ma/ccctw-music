  ...
  return (
    <div className="flex flex-col w-full ">
      ...
      <div className="flex flex-row justify-around items-center space-x-4 px-4 mb-1">
        <div className="block text-white text-xs">{timeFormatter(curMusicPlay.currentTime)}</div>
        ...
        <div className="block text-white text-xs">{timeFormatter(curMusicPlay.duration)}</div>
      </div>
